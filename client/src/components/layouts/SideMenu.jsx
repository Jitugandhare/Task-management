...
const SideMenu = ({ activeMenu }) => {
  ...
  return <div className='w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/50 sticky top-[61px] z-20 '>
    <div className='flex flex-col items-center justify-center mv-7 pt-5'>
      ...
      {user?.role === 'admin' && (
        <div className='text-[10px] font-medium text-white bg-blue-600 px-3 py-0.5 rounded-mt-1  '>Admin</div>
      )}
